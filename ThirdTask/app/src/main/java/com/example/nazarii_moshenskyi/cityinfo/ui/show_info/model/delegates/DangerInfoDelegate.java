...
public class DangerInfoDelegate extends AdapterDelegate<List<RowType>>  {
    private ViewHolderFactory.DangerViewHolder dangerInfoHolder;
    ...
    protected RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        return dangerInfoHolder = (ViewHolderFactory.DangerViewHolder) ViewHolderFactory.createDangerViewHolder(parent);
    }
    ...
    protected void onBindViewHolder(@NonNull List<RowType> items, int position, @NonNull RecyclerView.ViewHolder holder, @NonNull List<Object> payloads) {
        DangerInfo item = (DangerInfo) items.get(position);
        dangerInfoHolder.setDangerRating(item.getLevel());
    }
}
